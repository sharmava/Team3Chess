...
public class ChessView implements IChessView {
	...
	public ChessView() {
		...
		whitePieceImages.put(
				PieceType.BISHOP,
				new ImageIcon(ChessView.class
						.getResource("/images/WhiteBishop.gif")));
		whitePieceImages.put(
				PieceType.KING,
				new ImageIcon(ChessView.class
		...
		whitePieceImages.put(
				PieceType.KNIGHT,
				new ImageIcon(ChessView.class
						.getResource("/images/WhiteKnight.gif")));
		whitePieceImages.put(
				PieceType.PAWN,
				new ImageIcon(ChessView.class
						.getResource("/images/WhitePawn.gif")));
		whitePieceImages.put(
				PieceType.QUEEN,
				new ImageIcon(ChessView.class
						.getResource("/images/WhiteQueen.gif")));
		whitePieceImages.put(
				PieceType.ROOK,
				new ImageIcon(ChessView.class
						.getResource("/images/WhiteRook.gif")));

		blackPieceImages = new HashMap<PieceType, ImageIcon>();
		blackPieceImages.put(
				PieceType.BISHOP,
				new ImageIcon(ChessView.class
						.getResource("/images/BlackBishop.gif")));
		blackPieceImages.put(
				PieceType.KING,
				new ImageIcon(ChessView.class
						.getResource("/images/BlackKing.gif")));
		blackPieceImages.put(
				PieceType.KNIGHT,
				new ImageIcon(ChessView.class
						.getResource("/images/BlackKnight.gif")));
		blackPieceImages.put(
				PieceType.PAWN,
				new ImageIcon(ChessView.class
						.getResource("/images/BlackPawn.gif")));
		blackPieceImages.put(
				PieceType.QUEEN,
				new ImageIcon(ChessView.class
						.getResource("/images/BlackQueen.gif")));
		blackPieceImages.put(
				PieceType.ROOK,
				new ImageIcon(ChessView.class
						.getResource("/images/BlackRook.gif")));
